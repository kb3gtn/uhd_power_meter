...
The power measurements in this application has to be calibrated to your radio.  
The values output will most likely not be correct.

"windows_count" is a #define at the top of the source code
This controlls how many sample reads we integrate before reporting a received power level.
